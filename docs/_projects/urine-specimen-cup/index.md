---
title: "Urine Specimen Cup Redesign"
permalink: /projects/urine-specimen-cup/
project_main: true
sidebar:
  nav: "urine_specimen_cup_nav"
excerpt: "An improvement to the classic urine specimen cup to enable individuals with hand and/or finger impairments to independently collect urine."
header:
  teaser: /assets/images/urine-specimen-cup.png
classes: wide
---
...
<div align="center" style="margin-top: 1em; margin-bottom: 2.5em;">
    <img src="/assets/images/urine-specimen-cup.png" style="width: 50%; height: auto;">
</div>

Could a water bottle inspire a urine cup? Yuck — maybe it's better to first ask if it even _should_. But my line of thinking started with, "What are common items that may have been modified to make it easier for people with hand or finger impairments to use?" The ultimate challenge we aimed to address was the difficulty in holding and screwing or unscrewing the cup for individuals with hand and/or finger impairments. So, a natural parallel to the urine cup was a water bottle. I was confident that someone must have already modified the water bottle to make it easier for others to use. But who, and how? Could the modifications even be useful?
